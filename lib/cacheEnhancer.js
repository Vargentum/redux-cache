 ...
 */
exports.buildUpdateState = function (logResultFn, logGeneralFn) { return function (reducersToInvalidate, currentState, config) {
    ...
    var updatedState = cacheEnabledReducers.reduce(function (prev, reducerKey) {
        var _a, _b;
        return __assign({}, prev, (_a = {}, _a[reducerKey] = __assign({}, prev[reducerKey], (_b = {}, _b[cacheKey] = null, _b)), _a));
    }, newState);
    if (log) {
